...
function AnswerModel(storageClient, tableName, partitionKey) {
...
AnswerModel.prototype.add = function(item, callback) {
	var self = this;
  //item.RowKey = uuid();
...
AnswerModel.prototype.find = function(query, callback) {
  var self = this;
...
AnswerModel.prototype.findOne = function(query, callback) {
	self = this;
...
AnswerModel.prototype.updateItem = function(item, callback) {
  self = this;
  //item.PartitionKey = self.partitionKey;
...
AnswerModel.prototype.deleteItem = function(item, callback) {
  var self = this;
